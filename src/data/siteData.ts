    ...
    packages: [
      ...
      },
      {
        ...
        deliverables: [
          ...
          'Curated account management',
          '10 High-impact carousels',
          'Content mentorship & guidance',
          '5 Reels with professional editing',
          '1 Story per day nurture cadence',
        ],
      },
      {
        name: 'Advanced',
        ...
        deliverables: [
          ...
          'Complete curated account management',
          '20 High-impact editorial carousels',
          'Dedicated strategic content mentorship',
          'Up to 10 Reels with polished editing',
          '2 Stories per day for active audience engagement',
        ],
      },
    ],
    maintenanceNote:
